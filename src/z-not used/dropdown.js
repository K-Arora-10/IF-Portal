...
import { SignupFormDemo } from './resumesubmission';
...
export function ExpandableCardDemo() {
    ...
    return (
        <>
                ...
                {active && typeof active === "object" ? (
                    <div className="fixed inset-0 grid place-items-center z-[100]">
                        ...
                        <motion.div
                            ...
                            ref={ref}
                            className="w-full max-w-[500px] h-full md:h-fit md:max-h-[90%] flex flex-col bg-neutral-800 dark:bg-neutral-800 sm:rounded-3xl overflow-hidden"
                        >
                                ...
                                <div className="flex justify-between items-start p-4">
                                    <div>
                                        <motion.h3
                                            ...
                                            className="font-bold text-neutral-100 dark:text-neutral-200"
                                        >
                                            {active.title}
                                        </motion.h3>
                                        <motion.p
            ...
            <ul className="max-w-2xl mx-auto w-full gap-4 pt-24">
                {cards.map((card, index) => (
                    <motion.div
                        ...
                        onClick={(e) => {
                            ...
                            console.log("Card clicked:", card); // Debugging line
                        }}
                        className="p-4 flex flex-col md:flex-row justify-between items-center hover:bg-neutral-700 dark:hover:bg-neutral-800 rounded-xl cursor-pointer"
                    >
        ...
        content: () => {
            return (
                <p>
                    ...
                    icon in the heavy metal music industry. <br /> <br />
                    Their songs often reflect themes of aggression, social issues, and
                    personal struggles, capturing the essence of the heavy metal genre. With
                    a career spanning over four decades, Metallica has released numerous hit
        ...
        content: () => {
            return (
                <p>
                    ...
                    London in 1968, they have become a cultural icon in the rock music world.
                    <br /> <br />
                    Their songs often reflect a blend of blues, hard rock, and folk influences,
                    pushing the boundaries of contemporary rock music. With a career that
                    spanned over a decade, Led Zeppelin released numerous albums and songs
                    that continue to influence musicians and bands worldwide.
                </p>
            );
        },
    },
