...
const Footer = ({ theme }) => {
  ...
  const hoverColor =
    theme === "dark" ? "hover:text-gray-400" : "hover:text-gray-900";
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-2">
                <MapPin size={16} />
                <span>
                  Thapar Institute of Engineering & Technology, Thapar
                  Technology Campus, Bhadson Road, Patiala- 147004, Punjab
                </span>
              </li>
              <li className="flex items-center space-x-2">
                <Phone size={16} />
